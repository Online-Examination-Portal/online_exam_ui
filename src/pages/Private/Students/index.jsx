...
import StudentDrawer from '../../../components/private/students/drawer';
...
const Students = () => {
    return(
        <Box
        sx={classes.studentsContainer}
      >
        <Box 
          sx={classes.studentsheader}
        >
          <Box sx={{ flex: "0 1 auto" }}>
            <Typography
              variant="h3"
              color=" #194D6B"
              sx={classes.studentHeading}
            >
              Students
            </Typography>
        ...
        />
          ...
          <Box
            sx={classes.studentDrawerComponent}
          >
            <StudentDrawer />
          </Box>
        </Box>
